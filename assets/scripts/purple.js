jQuery( function() {
	...
	// The Echo extension puts an item in personal tools that Purple really should have in the top menu
	...
	if ( jQuery( '#ca-addsection' ).length ) {
		jQuery( 'li#ca-addsection a' ).html(
			'<div class="drop-icon"><i class="fa fa-plus fa-fw"></i></div>' +
			jQuery( 'li#ca-addsection a' ).attr( 'title' ).replace( /\[.+/g, '' )
		);
	}
